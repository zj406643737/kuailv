//
//  TheReceiveViewController.m
//  KuaiLv
//
//  Created by GH on 16/8/8.
...
@interface TheReceiveViewController ()<UITextFieldDelegate>

@end

@implementation TheReceiveViewController
...
- (void)createSenderMassage {
    ...
    NSArray *arrayMessage = @[@"请输入收件人姓名",@"请输入收件人电话",@"请输入收件人详细地址"];
...
- (void)makeSureMassage {
    ...
    if ([textFieldSender.text isEqualToString:@""]) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"Received" object:nil userInfo:@{@"key":strMessage}];
